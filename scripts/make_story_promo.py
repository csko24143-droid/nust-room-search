...
<style>
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .eyebrow{display:inline-flex;align-items:center;gap:12px;margin-top:110px;
  ...
  h1 .hl{color:#7dd3fc;}
  .photo{margin-top:80px;width:760px;height:760px;border-radius:40px;overflow:hidden;
...
<body>
  ...
  <div class="wrap">
    ...
    <h1>新しい投稿を<br><span class="hl">しました</span>📣</h1>
...
def main():
    ...
    html = TEMPLATE.replace("__IMG__", data_uri)
